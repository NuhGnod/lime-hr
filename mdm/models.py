...
class EvalPlan(models.Model):
    ...
    sf_eval_wght = models.IntegerField(blank=True, null=True, default=0)
    s_eval_wght = models.IntegerField(blank=True, null=True, default=0)
    m_eval_wght = models.IntegerField(blank=True, null=True, default=0)
    j_eval_wght = models.IntegerField(blank=True, null=True, default=0)
    t_eval_wght = models.IntegerField(blank=True, null=True, default=0)
    p_eval_wght = models.IntegerField(blank=True, null=True, default=0)
    reg_mem_no = models.IntegerField(blank=True, null=True)
    modf_mem_no = models.IntegerField(blank=True, null=True)
    reg_dt = models.DateTimeField(blank=True, null=True, auto_now_add=True)
    modf_dt = models.DateTimeField(blank=True, null=True, auto_now=True)
