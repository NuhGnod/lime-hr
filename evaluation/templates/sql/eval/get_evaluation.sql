...
WHERE aer.eval_stat_cd IS NULL
   OR aer.eval_stat_cd IN ('CC016001', 'CC016002')
GROUP BY A.eval_trgt_clss, A.be_eval_mem_no, A.eval_trgt_clss, A.eval_mem_no, A.eval_rel_no, A.eval_plan_no
