...
from .views import evaluation_main, get_all_evaluation, insert_evaluation_form, complete_evaluation, ajax_eval_check

app_name = 'evaluation'
app_category_name = '평가'

urlpatterns = [
    path('', evaluation_main, name='eval', kwargs={'app_name': app_name, 'app_category_name': app_category_name, 'page_name': '역량평가'}),
    ...
    path('ajax/check/', ajax_eval_check, name='eval_check'),
]